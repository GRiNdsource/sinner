...
local url , res = https.request('https://botdevmuslim.tk/muslim/api/sup/sub.php?ch=@JJJ0U&id='..User..'')
data = JSON.decode(url)
if data.Ch_Member.sinner ~= true then
Var = false
else
Var = true
end
